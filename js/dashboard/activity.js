...
export async function mount(ctx, container) {
  ...
  const state = {
    ...
    // Pending reader book-review count is surfaced on the dedicated Tasks page;
    // the compact Activity panel keeps it at 0 to avoid an extra read here.
  ...
  // Shared row renderer, bound to this page's toast + override-setter.
